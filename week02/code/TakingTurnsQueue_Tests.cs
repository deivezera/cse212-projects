...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The test wasn't work because class PersonQueue was using a List instead of a Queue to handle the data.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The test wasn't working because it had no validation for players with zero as turns.
    ...
    // Defect(s) Found: The test wasn't working because isEmpty() method wasn't checking the Count of the Queue
